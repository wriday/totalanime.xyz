...
API_ID = '24031219'
API_HASH = '389f48289d7f2d9b19efdb5f0146f45e'
BOT_TOKEN = '7343199921:AAE5I0U84ZKIkyUq66al-2utGTKm0KNX2qc'
...
PRIME_LOGO = (environ.get('PRIME_LOGO', 'https://telegra.ph/file/1a355f2a7520afa55b5fd.jpg'))

# Admins, Channels & Users *
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '5769389481').split()]
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '0').split()]
auth_users = [int(user) if id_pattern.search(user) else user for user in environ.get('AUTH_USERS', '5769389481').split()]
AUTH_USERS = (auth_users + ADMINS) if auth_users else []
auth_channel = '-1002075871954'
auth_grp = environ.get('AUTH_GROUP')
AUTH_CHANNEL = int(auth_channel) if auth_channel and id_pattern.search(auth_channel) else None
AUTH_GROUPS = [int(ch) for ch in auth_grp.split()] if auth_grp else None

# MongoDB information *
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://teslacompany80:tahoor12@cluster0.lyjnt.mongodb.net/?retryWrites=true&w=majority")
DATABASE_NAME = environ.get('DATABASE_NAME', "Cluster0")
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'Tg_files')

# LOG CHANNELS *
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', 0))
LAZY_GROUP_LOGS = '-1002198517626'
REQ_CHANNEL = '-1002075871954'
PRIME_MEMBERS_LOGS = '-1002198517626'
...
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '-1002198517626')).split()]
...
ADMIN_USRNM = environ.get('ADMIN_USRNM','inkosiyehacker') # WITHOUT @
MAIN_CHANNEL_USRNM = environ.get('MAIN_CHANNEL_USRNM','totalanime_movies') # WITHOUT @
DEV_CHANNEL_USRNM = environ.get('DEV_CHANNEL_USRNM','totalanime_movies') # WITHOUT @
LAZY_YT_HANDLE = environ.get('LAZY_YT_HANDLE','totalanime_')  # WITHOUT @ [  add only handle - don't add full url  ] 
MOVIE_GROUP_USERNAME = 'totalanime_movies' #[ without @ ]
